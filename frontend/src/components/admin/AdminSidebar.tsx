...
export function AdminSidebar() {
  ...
  const navItems = [
    { href: "/admin", label: t("admin.home"), icon: LayoutDashboard },
    { href: "/admin/reservations", label: t("admin.reservations") || "Reservations", icon: BookOpen },
      ...
      >
        ...
        <div className="px-6 pt-7 pb-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-500 leading-tight">Dashboard</p>
          </div>
        </div>
